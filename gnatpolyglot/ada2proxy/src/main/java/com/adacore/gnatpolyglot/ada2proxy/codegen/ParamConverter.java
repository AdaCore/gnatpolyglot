...
public class ParamConverter {
    ...
    private class Worker implements TypeWorker<String> {
        ...
        public String arrayAccessType(Libadalang.BaseTypeDecl type) {
            ...
            if (isOutMode) {
                // The GNATpolyglot array is passed by reference (System.Address). we need to create
                // an overlay from the given address. its values will be update after calling the
                // bound subprogram.
