...
#ifndef GNATPOLYGLOT_ADA_EXCEPTIONS_H
#define GNATPOLYGLOT_ADA_EXCEPTIONS_H
...
class AdaException : public gnatpolyglot::exceptions::polyglot_exception {
public:
...
#endif /* ! GNATPOLYGLOT_ADA_EXCEPTIONS_H */
