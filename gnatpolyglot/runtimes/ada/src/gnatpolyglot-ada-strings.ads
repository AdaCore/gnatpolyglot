...
package GNATpolyglot.Ada.Strings is
   ...
   pragma Export (C, String_Alloc, "gnatpolyglot__ada__strings__string_alloc");

   procedure String_Construct is new Construct (Interfaces.C.char);
   pragma
     Export (C, String_Construct, "gnatpolyglot__ada__strings__string_construct");

   function String_Clone is new Clone (Interfaces.C.char);
   pragma Export (C, String_Clone, "gnatpolyglot__ada__strings__string_clone");

   procedure String_Copy is new Copy (Interfaces.C.char);
   pragma Export (C, String_Copy, "gnatpolyglot__ada__strings__string_copy");

   procedure String_Free is new Free (Interfaces.C.char);
   pragma Export (C, String_Free, "gnatpolyglot__ada__strings__string_free");

   function String_Get is new Get (Interfaces.C.char);
   pragma Export (C, String_Get, "gnatpolyglot__ada__strings__string_get");

   procedure String_Set is new Set (Interfaces.C.char);
   pragma Export (C, String_Set, "gnatpolyglot__ada__strings__string_set");
   ...
   pragma Export (C, To_C_Char_Ptr, "gnatpolyglot__ada__strings_to_c_chars_ptr");

   function From_C_Char_Ptr
     (Ptr : Interfaces.C.Strings.chars_ptr) return Polyglot_String;
   pragma
     Export (C, From_C_Char_Ptr, "gnatpolyglot__ada__strings_from_c_chars_ptr");

   procedure Free_C_Char_Ptr (Item : Interfaces.C.Strings.chars_ptr);
   pragma
     Export (C, Free_C_Char_Ptr, "gnatpolyglot__ada__strings_free_c_chars_ptr");

end GNATpolyglot.Ada.Strings;
