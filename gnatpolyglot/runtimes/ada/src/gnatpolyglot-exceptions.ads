...
with GNATpolyglot; use GNATpolyglot;
with GNATpolyglot.Ada.Strings;

package GNATpolyglot.Exceptions is
   ...
   pragma
     Export
       (C,
        ...
        "gnatpolyglot__ada__exceptions__create_exception_occurence");

   function Create_Exception_Occurence_Message
     (Kind : Standard_Exception_Kind;
      Msg  : GNATpolyglot.Ada.Strings.Polyglot_String) return System.Address;
   pragma
     Export
       (C,
   ...
   pragma
     Export
       (C,
        ...
        "gnatpolyglot__ada__exceptions__free_exception_occurence");
   ...
   pragma
     Export
       (C,
        Get_Cstr_Message,
        "gnatpolyglot__ada__exceptions__get_cstr_message");

end GNATpolyglot.Exceptions;
