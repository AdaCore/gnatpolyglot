...
public class CharacterArray extends PolyglotArray<Character> {
     ...
     */
    public CharacterArray(ArrayData data) {
        super(data);
    }
     ...
     */
    public CharacterArray(ArrayData data, PolyglotObject parent) {
        super(data, parent);
    }

    public CharacterArray(int first, int last) {
    ...
    private static native char arrayGet(ArrayData data, int index);

    @Override
    public Character getUnslided(int index) {
        return arrayGet(_getData(), index);
    }

    private static native char arraySet(ArrayData data, int index, char element);

    @Override
    public Character setUnslided(int index, Character element) {
    ...
    public CharacterArray clone() {
        ...
        return new CharacterArray(data);
    }

    public static final class Ref extends ObjectRef<CharacterArray> {
        public Ref(CharacterArray obj) {
            super(obj);
        }

        private Ref(ArrayData data) {
            super(data == null ? null : new CharacterArray(data));
