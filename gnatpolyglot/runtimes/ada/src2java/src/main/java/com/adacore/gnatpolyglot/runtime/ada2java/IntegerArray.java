...
public class IntegerArray extends PolyglotArray<Integer> {
    ...
    public static final class Ref extends ObjectRef<IntegerArray> {
        public Ref(IntegerArray obj) {
            super(obj);
        }

        private Ref(ArrayData data) {
            super(data == null ? null : new IntegerArray(data));
