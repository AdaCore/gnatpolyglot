...
public class Main {
    ...
    static void useFree() {
        ...
        ptr1.get().get()._setOwner(Owner.LIBRARY);
    ...
    static void recursiveRec() {
        ...
        item1._setOwner(Owner.LIBRARY);
        ListItem item2 = new ListItem(2);
        item2._setOwner(Owner.LIBRARY);
        ...
        item3._setOwner(Owner.LIBRARY);
        item2.setNext(item3);
        System.out.println(list.get(2).get().getValue());

        item1._setOwner(Owner.USER);
        item2._setOwner(Owner.USER);
        item3._setOwner(Owner.USER);
    }
