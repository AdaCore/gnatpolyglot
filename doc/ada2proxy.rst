...
The Ada2Proxy tool is invoked as a subcommand of the Polyglot program.
It must be provided with at least a project file and an output path:

.. code:: sh

   $> polyglot ada2proxy -P<project-file> -o<output-path> {<switch>}
...
Moreover, please note that polyglot will always make sure that the
